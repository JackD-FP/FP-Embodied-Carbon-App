...
def card3_total_gfa_update(val, conc_val, steel_val, timber_val, data):
    if val is None:
        ...
        return html.H3(total), html.H3(np.around(total_per_m2, 2)), gb_concrete, gb_steel, gb_timber, pie_child
...
def card3_total_gfa_update(val, conc_val, steel_val, timber_val, data):
    if val is None:
        ...
        return html.H3(total), html.H3(np.around(total_per_m2, 2)), epic_concrete, epic_steel, epic_timber, pie_child
