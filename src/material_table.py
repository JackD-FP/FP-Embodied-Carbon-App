...
def table_gen(
    ...
    row2 = html.Tr([html.Td(rebar_input), html.Td(rebar_out)])
    row3 = html.Tr([html.Td(steel_input), html.Td(steel_out)])
    row4 = html.Tr([html.Td(timber_input), html.Td(timber_output)])
