...
def cards_update(
        ...
        if row["Element"] == "Beam":
            material_dict = {
                ...
                "Structural Timber": funcs.timber(
                    beam_timber, row["Mass"], row["Volume"], source=beams.timber_options
                ),
            }
            ...
            material_dict = {
                ...
                "Structural Timber": funcs.timber(
                    slab_timber, row["Mass"], row["Volume"], source=slabs.timber_options
                ),
            }
            sub_materials.append(
                material_dict.get(row["Materials"])[0]
            ...
            material_dict = {
                ...
                "Structural Timber": funcs.timber(
                    wall_timber, row["Mass"], row["Volume"], source=walls.timber_options
                ),
            }
    ...
    df_grouped = df.groupby(["EPiC Submaterial", "EPiC Colors"], as_index=False).sum()
