    ...
    if data_check(df):
        ...
        fig.update_layout(
            ...
            annotations=[
                ...
                dict(
                    text="{:,d}M kgCO₂e".format(int(gb_sum / 1000000)),
                    xref="paper",
                    yref="paper",
                    x=0.1,
                    y=0.55,
                ...
                dict(
                    text="{:,d}M kgCO₂e".format(int(epic_sum / 1000000)),
                    xref="paper",
                    yref="paper",
                    x=0.5,
                    y=0.55,
                ...
                dict(
                    text="{:,d}M kgCO₂e".format(int(ice_sum / 1000000)),
                    xref="paper",
                    yref="paper",
                    x=0.89,
                    y=0.55,
        ...
        # fig.update_annotations(text="Greenbook", valign="middle"),  # type: ignore
