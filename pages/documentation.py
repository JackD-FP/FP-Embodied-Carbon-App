...
layout = html.Div([
    ...
    html.Div([
        ...
        html.P("The Embodied Carbon App is built to help architects and designers make informed decisions.\
        ...
        html.P("This app free and open source for anyone. \
        ...
        html.Hr(className="mb-5"),
        html.P(["To get started, open up any project with your ArchiCAD version of your choosing.\
            Once opened,",
            html.Strong(" right click"), 
            " on",
            html.Strong(' "Components"'),"and click",
            html.Strong(' "New Schedule…"'), 
            ". A new Scheme Settings should have opened."]),
        html.Img(src="/assets/step_1.png", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P(["Give the schedule it's ", 
        html.Strong("ID"),
        " and",
        html.Strong(" Name "), 
        ...
        dbc.Button("Download", id="download_btn", outline=True, color="primary", className="mb-3 d-block mx-auto"),
        dcc.Download(id="download"),
        html.Img(src="/assets/step_2.png", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P([
        ...
        html.Img(src="/assets/step_3.png", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P("After creating a schedule, you are ready to upload. \
            You can drag the schedule into the dropzone \
            or click and navigate towards it.", className="mt-5"
            ),
        html.Img(src="/assets/upload.gif", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P([
            "There are few ", 
            html.Span([
                dmc.Tooltip(
        ...
        html.Hr(className="mb-5"),
        html.P("There are 3 main pages to the application. \
        ...
        dbc.Button("Download", id="example_btn", outline=True, color="primary", className="my-3 d-block mx-auto"),
        ...
        html.Img(src="/assets/Dashboard.gif", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P([
        ...
        html.Img(src="/assets/Analysis.gif", className="img-fluid w-75 d-block mx-auto mb-5"),
        html.P([
            "Finally ",
        ...
        html.Img(src="/assets/comparison.gif", className="img-fluid w-75 d-block mx-auto mb-5"),
